...
<div class="logo">
    <a href="index.html">
        <img style="height: 100px; width: 100px" src="{{asset('landing_page/images/logo.svg')}}" alt="" /> </a>
</div>
...
<script src="{{url('metronic/assets/global/plugins/backstretch/jquery.backstretch.min.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
